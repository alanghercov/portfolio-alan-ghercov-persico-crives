...
| :--- | :--- | :---: | 
| **Sistema de Auditoria de Recursos Corporativos** | sistema que calcula o financeamento de diferentes setores de uma empresa | [Ver Projeto](./projeto-sistema-de-auditoria-de-recursos-corporativos/) |
| :--- | :--- | :---: | 
